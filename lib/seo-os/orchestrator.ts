...
import { getRoadmap, saveRoadmap } from './roadmap-engine';
...
export async function runDailyCycle(isManual: boolean = false) {
  ...
  // If system is paused, skip the cycle unless manual
