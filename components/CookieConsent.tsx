      ...
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className="bg-accent text-slate-900 font-bold px-6 py-2 rounded text-sm hover:bg-accent-dark transition-colors"
          >
            Accept All
          </button>
          <button
            onClick={handleDecline}
            className="border border-white/30 text-white font-bold px-6 py-2 rounded text-sm hover:bg-white/10 transition-colors"
          >
