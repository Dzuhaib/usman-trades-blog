  ...
  return (
    <article className="max-w-[720px] mx-auto space-y-8">
      ...
      <section className="space-y-4 text-secondary leading-relaxed">
        ...
        <p>
          By accessing and using the website usmantrades.co.uk (the "Site"), you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use our utility tools or educational resources.
        </p>
      </section>
