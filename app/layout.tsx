...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://www.usmantrades.uk"),
  alternates: {
    canonical: "/",
  },
  keywords: [
  ...
  authors: [{ name: "Usman Trades", url: "https://www.usmantrades.uk" }],
...
function WebsiteJsonLd() {
  const jsonLd = {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target: "https://www.usmantrades.uk/blog?category={search_term_string}",
